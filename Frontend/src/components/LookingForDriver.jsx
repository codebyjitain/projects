...
const LookingForDriver = (props) => {
  return (
    <div>
            ...
            <h3 className='mb-5 text-2xl text-center font-medium'>Looking For Driver</h3>
            <div className='flex justify-between flex-col gap-2 items-center'>

                {/* maybe edit later */}
                <img onClick={()=>{
                    props.setWaitingForDriver(true)
                }} className='w-[150px]' src="https://www.svgrepo.com/show/408291/car-white.svg" alt="car image" />
